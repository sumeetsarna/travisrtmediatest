...
public class PhotoTest {
	...
	/*			// Click on rtMedia settings BuddyPress Tab
						...
						boolean checkBox2 = wd.findElement(By.id("rtmedia-bp-enable-activity")).isSelected();
						if (checkBox2 == false)
...
.cssSelector("span.rt-form-checkbox> label[for=\"rtmedia-bp-enable-activity\"] > div.rt-switch.has-switch > div.switch-animate.switch-off"));
	...
	System.out.println("'Allow Upload From Activity Stream' is switched  on");
		...
		//   Photos
		// Check if the switch for Allow Photos Upload is on or off,  if its off then switch it to on and proceed
		...
		List<WebElement> switchElement2 = wd.findElements(By
				.cssSelector("span.rt-form-checkbox> label[for=\"rt-form-checkbox-18\"] > div.rt-switch.has-switch > div.switch-animate.switch-off"));
						...
						System.out.println("'The setting for enabling Photos' is switched  on");
							} 
						else
							System.out.println("The Switch for enabling Photos  is already ON");
((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/MediaTypes/Photo/Functional/Photo 01.png');");																
	// Set featured is used as  a cover photo in InspireBook . Not including the cases here
				
		/*	// Set Upload Limits for Photos  
				
				// enter a number > 0 in settings.  

				wd.findElement(By.id("rt-form-number-4")).click();
				wd.findElement(By.id("rt-form-number-4")).clear();
				//0 is unlimited photo uploads . Change to check upload  limits (MB)
				wd.findElement(By.id("rt-form-number-4")).sendKeys("1");
				*/
				...
				wd.findElement(By.id("whats-new")).sendKeys("Check  Media Type : Photos (jpg, jpeg, png, gif)");
				
((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/MediaTypes/Photo/Functional/Photo 02.png');");
	...
	/*					
				((PhantomJSDriver) wd).executePhantomJS("var page=this; "
						...
						+"page.render('./screen/MediaTypes/Functional/Photo.png');");*/

				((PhantomJSDriver) wd).executePhantomJS("var page=this; "
				        + "var count=0;" + "page.uploadFile('input[type=file]',['"
				        + Constants.PhotoPhantom +"','"+Constants.Photo2+"']);");			
				Thread.sleep(4000); // Increase sleep for Music and Video uploads
	((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/MediaTypes/Photo/Functional/Photo 03.png');");				
				// Enter some content

				wd.findElement(By.id("whats-new")).click();
				wd.findElement(By.id("whats-new")).clear();
				wd.findElement(By.id("whats-new")).sendKeys("Check Images ");				
				System.out.println("Check Images  text entered");	
				Thread.sleep(4000);
				...
				Thread.sleep(6000);
				((PhantomJSDriver) wd).executePhantomJS("var page=this;" +"page.render('./screen/MediaTypes/Photo/Functional/Photo 04.png');");
